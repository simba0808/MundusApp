...
export const CarouselData = [
  {
    title: "Revolutionary Discovery in Medicine",
    contents:
      "Researchers reveal significant breakthrough in the treatment of chronic diseases",
    related_news: [
      {
  ...
  {
    title: "Technological Innovations Transform the Automotive Industry",
    contents: "Explore the latest technologies shaping the future of vehicles.",
    related_news: [
      {
  ...
  {
    title:
      "Pop Culture Boiling Over: Interview with the Celebrity of the Moment",
    contents:
      "Uncover the behind-the-scenes life of the star dominating the headlines.",
    related_news: [
      {
